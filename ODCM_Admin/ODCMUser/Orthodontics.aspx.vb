...
Partial Class Orthodontics
    ...
    Public Sub LoadPatientTeethInfo()
        ...
        SqlQuery("select a.teethid,concat(b.lastname,', ',b.firstname,' ',b.middlename) as name,a.service,DATE_FORMAT(a.examdate,'%m/%d/%Y'),a.chiefcomplaint,a.dentalhistory,a.medication,a.congenital,a.temporo,a.oralhygiene,a.gingival,a.diagnosis from patientteeth a, clienttbl b where a.clientid=b.clientid and a.id='" & userID & "'")

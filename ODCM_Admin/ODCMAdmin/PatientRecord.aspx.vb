...
Partial Class PatientRecord
    ...
    Public Sub GetClientInformation()
        SqlQuery("select lastname,firstname,middlename,DATE_FORMAT(birthdate,'%M %d, %Y'),age,gender,religion,nationality,guardian,nickname,occupation,address,phonenumber,emailaddress,homeno,officeno,dentalinsurance,faxno,DATE_FORMAT(effectivedate,'%M %d, %Y'),guardianoccup from clienttbl where clientid='" & Session("ClientID") & "'")
    ...
    Private Sub RadGrid1_ItemCommand(sender As Object, e As GridCommandEventArgs) Handles RadGrid1.ItemCommand
        If e.CommandName = "View" Then
            ...
            Response.Redirect("Orthodontics.aspx")
        End If
    End Sub
    Protected Sub RadGrid1_NeedDataSource(sender As Object, e As GridNeedDataSourceEventArgs) Handles RadGrid1.NeedDataSource
        ...
        SqlQuery("select id,teethid,service,diagnosis,DATE_FORMAT(examdate,'%M %d, %Y') as examdate from patientteeth where clientid='" & Session("ClientID") & "' order by examdate  desc")

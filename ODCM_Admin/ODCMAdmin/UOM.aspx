<%@ Page Title="Unit of Measurement" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="UOM.aspx.vb" Inherits="Service" %>
    ...
    <div>
         ...
         AllowSorting="True" Width="50%"
            ...
            <MasterTableView Width="100%" CommandItemDisplay="Top"
                DataKeyNames="uom_id" InsertItemDisplay="Top"
                ...
                <Columns>
                    ...
                    <ItemTemplate>
                     ...
                     <telerik:GridBoundColumn DataField="uom_id" UniqueName="uom_id" HeaderText="UOM ID" Display="false">
                        <HeaderStyle Font-Bold="True" HorizontalAlign="Center" VerticalAlign="Middle" />
                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                    </telerik:GridBoundColumn>

                    <telerik:GridBoundColumn DataField="uom_name" UniqueName="uom_name" HeaderText="Unit Of Measurement"
                        MaxLength="50">
                        <HeaderStyle Font-Bold="True" HorizontalAlign="Center" VerticalAlign="Middle" />
                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                    </telerik:GridBoundColumn>

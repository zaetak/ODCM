...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
        ...
        <h2 style="font-family: 'Century Gothic'; font-weight: bold;" class ="text-center">PATIENT DIAGNOSIS</h2>
  ...
  <telerik:RadGrid RenderMode="Lightweight" ID="RadGrid1" AllowSorting="True" Width="90%"
            AllowAutomaticInserts="True" AllowAutomaticUpdates="True" AllowAutomaticDeletes="True" OnNeedDataSource="RadGrid1_NeedDataSource" runat="server" AutoGenerateColumns="False" GroupPanelPosition="Top" Skin="Bootstrap">

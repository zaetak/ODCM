<%@ Page Title="Supply Categories" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="Categories.aspx.vb" Inherits="Service" %>
   ...
   { 
    ...
    .rgMasterTable
    {
        ...
        <tr>
            ...
            <td style="width: 88px" class="text-right"> <telerik:RadLabel ID="RadLabel1" runat="server" Skin="Bootstrap" style="font-size: large" Font-Bold="False" Font-Names="Century Gothic" Font-Size="Medium">
    ...
    <center>
    <div>
         <telerik:RadGrid RenderMode="Lightweight" ID="RadGrid1" AllowSorting="True" Width="50%"
            ...
            OnDeleteCommand="RadGrid_ItemDeleted" AutoGenerateColumns="False" GroupPanelPosition="Top" Skin="Bootstrap">
            <PagerStyle Mode="NextPrevAndNumeric"></PagerStyle>
            <MasterTableView Width="100%" CommandItemDisplay="Top"
                DataKeyNames="cat_id" InsertItemDisplay="Top"
                ...
                <Columns>
                    ...
                    <ItemTemplate>
                     ...
                     <telerik:GridBoundColumn DataField="cat_id" UniqueName="cat_id" HeaderText="Category ID" Display="false">
                        <HeaderStyle Font-Bold="True" HorizontalAlign="Center" VerticalAlign="Middle" />
                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                    </telerik:GridBoundColumn>

                    <telerik:GridBoundColumn DataField="cat_name" UniqueName="cat_name" HeaderText="Supply Categories"
                        MaxLength="50">
                        <HeaderStyle Font-Bold="True" HorizontalAlign="Center" VerticalAlign="Middle" />
                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                    </telerik:GridBoundColumn>

...
<table  style="width:100%;">
        <tr>
            ...
            <td style="width: 803px; height: 37px">
                <telerik:RadLabel ID="Teethid" runat="server" Font-Names="Century Gothic" Font-Size="Medium" Skin="Bootstrap" Font-Bold="True">
         ...
         <tr>
            ...
            <td style="width: 71px; height: 67px;"></td>
             ...
             <td style="width: 803px; height: 67px">
                   <strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <telerik:RadButton ID="RadButton1" runat="server" Font-Bold="True" Font-Names="Century Gothic" Height="33px" style="font-size: 16px; left: 0px; top: 4px; margin-top: 0px" Text="Submit" Width="143px" Skin="Bootstrap" BorderColor="#666666">
                </telerik:RadButton>
                </strong></td>

<%@ Page Title="Stocks Monitoring" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="ServiceGraph.aspx.vb" Inherits="ServiceGraph" %>
    ...
    .ModalBackground
{
  ...
  <script type="text/javascript">
    ...
    <h2 style="font-family: 'Century Gothic'; font-weight: bold;" class ="text-center">SERVICE INFORMATION STATISTICS</h2>>
    <table style="width:100%; height: 76px;">
        ...
        <tr>
            ...
            <td class="auto-style6">
                <telerik:RadComboBox ID="Service" Runat="server" Font-Names="Century Gothic" Font-Size="Medium" Width="213px" Skin="Bootstrap" AutoPostBack="True" EmptyMessage="Choose Timespan">
                    <Items>
    ...
    <PlotArea>
        ...
        <XAxis DataLabelsField="Name" AxisCrossingValue="0" Color="black" MajorTickType="Outside" MinorTickType="Outside"
            ...
            <LabelsAppearance DataFormatString="{0}" RotationAngle="0" Skip="0" Step="1"></LabelsAppearance>
                    <TitleAppearance Position="Center" RotationAngle="0" Text="Service">
                    </TitleAppearance>
        </XAxis>
